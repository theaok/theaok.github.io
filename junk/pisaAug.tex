...
\marginsize{2cm}{2cm}{1.5cm}{1.5cm}%{left}{right}{top}{bottom}   
...
Life Satisfaction and Eudaimonia is Lower in Urban Adolescents
...
\begin{spacing}{1.9} %TODO MAYBE before submission can make it like 2.0
...
\item negative effect  of large city ($>$1m) on happiness: about -0.5 on
  0-10 scale
\item negative effect  of large city ($>$1m)  on eudaimonia: -0.1 to -0.15 on % -2.1 to 1.7
...
% arguing that if there were more skilled workers in a city, cities would not have
...
% It is a familiar argument by economists that more education solves
...
% \footnote{While it is true that adolescents cannot choose where they
...
We use the 2018 PISA data % (Programme for International Student Assessment)
 ...
 %
The 2018 PISA is a large dataset with $>0.5m$ observations across 80 %142
countries (including some sub-country regions), % \footnote{The adolescent datafile at \url{https://www.oecd.org/pisa/data/2018database} has 80 countries. PISA website lists 83 participants at \url{https://www.oecd.org/pisa/aboutpisa/pisa-participants.htm}.}
...
% It is currently underused, for instance, only 4 papers in the journal \textit{Cities} have used it, and all focusing on China only \citep{hu2019segregation,du2020influence,murgante2024developing,lee2022drives}. 
 
\begin{spacing}{.9}\input{varDesED.tex}\end{spacing} 
...
models a1-a3. % ; perhaps in the open country (lt3k) there are better outdoor play opportunities
 %arthur: 
...
\begin{table}[H]\centering\caption{OLS Regressions of Life Satisfaction. Base category for settlement size is $<$3k.} \label{regA} \begin{scriptsize} \begin{tabular}{p{1.6in}p{.5in}p{.5in}p{.5in}p{.5in}p{.5in}|p{.5in}p{.5in}|p{.5in}|p{.5in}p{.5in}p{.5 in}p{.5in}p{.5 in}}\hline \input{../out/regA.tex} \hline\multicolumn{4}{l}{*p$<$0.05 **p$<$0.01 ***p$<$0.001} \end{tabular}\end{scriptsize}\end{table}
...
urban happiness since rural areas are often less livable with insufficient availability of basic necessities such as food, water, and shelter.}%---better suffer urban disamenities than struggle to survive in a desert or jungle.   
...
column b6 % and b7
 for consistency with those for life satisfaction. % (From the results with country fixed effects
% included,
...
\begin{table}[H]\centering\caption{OLS regressions of Eudaimonia. Base category for settlement size is $<$3k.} \label{regB} \begin{scriptsize} \begin{tabular}{p{1.6in}p{.5in}p{.5in}p{.5in}p{.5in}p{.5in}|p{.5in}p{.5in}|p{.5in}|p{.5in}p{.5in}p{.5 in}p{.5in}p{.5 in}}\hline \input{../out/regB.tex} \hline\multicolumn{4}{l}{*p$<$0.05 **p$<$0.01 ***p$<$0.001} \end{tabular}\end{scriptsize}\end{table}
...
relative to a more rural setting. % The setup, restrictions, and complexity of city life can weigh down on children/teens.
...
%RV: I think we should remove the "elderly" angle and just focus on children/teens
...
% % rubia
% An important
One limitation is that although we would like to take into account possible grandparent and sibling effects, we do not have such measures in the 2018 PISA. % also look into the caretakers and extended family (grandparents).
...
especially given that people in smaller places and rural areas still have more children than people living in mega-cities \citep{lerch2019regional}. % Children having other children around to interact and play with can boost happiness. Finally, arguably after the pandemic, adolescents in cities became even more unhappy just as adults did
