...
\noindent{\sc keywords:  city, urbanism, trust, misanthropy, distrust, fairness,
  helpfulness, US General Social Survey (GSS)}%, social capital
%\vspace{-.25in} 
...
make crime more likely  \citet[see ][]{glaeser1999}. % The higher crime rates in big cities are particularly salient to our research given that
...
may be not the size of a place that causes higher misanthropy, but %a lack of success
...
. 
 ...
 planners and practicioners. % in order mitigate them.
